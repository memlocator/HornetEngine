...
{
	Data[0][2] = vector.X * Data[0][0] + vector.Y * Data[0][1];
	Data[1][2] = vector.X * Data[1][0] + vector.Y * Data[1][1];
	Data[2][2] = vector.X * Data[2][0] + vector.Y * Data[2][1];
...
Matrix3Type<Number>& Matrix3Type<Number>::TransformAround(const Vec2& point)
{
	...
	Data[0][2] = translationVector.X;
	Data[1][2] = translationVector.Y;
	Data[2][2] = 1.f;
...
{
	return Vec2(Data[0][0], Data[1][0], 0.f);
}
...
{
	return Vec2(Data[0][1], Data[1][1], 0.f);
}
...
{
	return Vec2(Data[0][2], Data[1][2], 1.f);
}
...
{
	return Vec2(
		other.X * Data[0][0] + other.Y * Data[0][1] + other.Z * Data[0][2],
		other.X * Data[1][0] + other.Y * Data[1][1] + other.Z * Data[1][2],
		other.X * Data[2][0] + other.Y * Data[2][1] + other.Z * Data[2][2]
		);
}
...
std::ostream& operator<<(std::ostream& out, const Matrix3Type<Number>& matrix)
{
	...
	out << "[ " << matrix.Data[0][0] << ", " << matrix.Data[0][1] << ", " << matrix.Data[0][2] << " ]\n"
		<< "[ " << matrix.Data[1][0] << ", " << matrix.Data[1][1] << ", " << matrix.Data[1][2] << " ]\n"
		<< "[ " << matrix.Data[2][0] << ", " << matrix.Data[2][1] << ", " << matrix.Data[2][2] << " ]" << std::endl;
