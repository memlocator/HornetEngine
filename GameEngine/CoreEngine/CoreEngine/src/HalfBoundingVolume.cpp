...
namespace CoreMeshes
{
	const MeshData& HalfBoundingVolume()
	{
		...
		data.Vertices = {
			Vector3( -0.750000f, -0.000000f,  0.750000f, 1.f),
			Vector3( -1.000000f,  0.333333f,  0.333333f, 1.f),
			Vector3( -1.000000f, -0.000000f,  0.333333f, 1.f),
			Vector3( -0.750000f,  0.000000f, -0.750000f, 1.f),
			Vector3(  0.750000f,  0.000000f, -0.750000f, 1.f),
			Vector3(  0.750000f,  0.000000f, -0.750000f, 1.f),
			Vector3( -1.000000f,  0.333333f,  0.333333f, 1.f),
			Vector3( -1.000000f,  0.000000f,  0.000000f, 1.f),
			Vector3( -1.000000f, -0.000000f,  0.333333f, 1.f),
			Vector3(  0.333333f,  0.333333f,  1.000000f, 1.f),
			Vector3(  0.000000f, -0.000000f,  1.000000f, 1.f),
			Vector3(  0.333333f, -0.000000f,  1.000000f, 1.f),
			Vector3(  0.583333f,  0.666667f,  0.583333f, 1.f),
			Vector3(  0.000000f,  0.750000f,  0.750000f, 1.f),
			Vector3(  0.333333f,  0.333333f,  1.000000f, 1.f),
			Vector3(  0.333333f,  0.000000f, -1.000000f, 1.f),
			Vector3(  0.333333f,  0.333333f, -1.000000f, 1.f),
			Vector3(  0.750000f,  0.000000f, -0.750000f, 1.f),
			...
			Vector3( -1.000000f,  0.000000f,  0.000000f, 1.f),
			Vector3( -0.750000f,  0.000000f, -0.750000f, 1.f),
			Vector3(  0.750000f,  0.750000f,  0.000000f, 1.f),
			Vector3(  0.333333f,  1.000000f, -0.333333f, 1.f),
			Vector3(  0.333333f,  1.000000f,  0.333333f, 1.f),
			Vector3(  0.000000f,  0.750000f, -0.750000f, 1.f),
			Vector3(  0.333333f,  1.000000f, -0.333333f, 1.f),
			Vector3(  0.583333f,  0.666667f, -0.583333f, 1.f),
