...
namespace CoreMeshes
{
	const MeshData& Cone()
	{
		...
		data.Vertices = {
			Vector3( 0.000000f,  0.000000f,  0.000000f, 1.f),
			Vector3(-0.198992f,  1.000000f,  1.000000f, 1.f),	
			Vector3( 0.198992f,  1.000000f,  1.000000f, 1.f),	
			Vector3( 0.566682f,  1.000000f,  0.848099f, 1.f),	
			Vector3( 0.848099f,  1.000000f,  0.566682f, 1.f),	
			Vector3( 1.000000f,  1.000000f,  0.198992f, 1.f),	
			Vector3( 1.000000f,  1.000000f, -0.198992f, 1.f),	
			Vector3( 0.848099f,  1.000000f, -0.566682f, 1.f),	
			Vector3( 0.566682f,  1.000000f, -0.848099f, 1.f),	
			Vector3( 0.198992f,  1.000000f, -1.000000f, 1.f),	
			Vector3(-0.198992f,  1.000000f, -1.000000f, 1.f),	
			Vector3(-0.566681f,  1.000000f, -0.848099f, 1.f),	
			Vector3(-0.848099f,  1.000000f, -0.566682f, 1.f),	
			Vector3(-1.000000f,  1.000000f, -0.198992f, 1.f),	
			Vector3(-1.000000f,  1.000000f,  0.198992f, 1.f),	
			Vector3(-0.848099f,  1.000000f,  0.566682f, 1.f),	
		...
		data.Colors = { { 1._F, 1._F, 1._F, 1._F } };
